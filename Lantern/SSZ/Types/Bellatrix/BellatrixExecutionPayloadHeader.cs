...
public class BellatrixExecutionPayloadHeader
{
        ...
        public static BellatrixExecutionPayloadHeader Serialize(ExecutionPayloadHeader executionHeader)
        {            
            BellatrixExecutionPayloadHeader executionHeaderSSZ = new BellatrixExecutionPayloadHeader();
        ...
        public static ExecutionPayloadHeader Deserialize(BellatrixExecutionPayloadHeader executionHeaderSSZ)
        {
