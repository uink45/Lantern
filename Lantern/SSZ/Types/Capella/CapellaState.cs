...
public class CapellaState
{
    ...
    [SszElement(24, "Container")] public CapellaExecutionPayloadHeader LastExecutionPayloadHeader { get; set; }
    ...
    [SszElement(27, "List[Container[Lantern.SSZ.Types.HistoricalSummarySSZ], HISTORICAL_ROOTS_LIMIT]")] public List<HistoricalSummarySSZ> HistoricalSummaries { get; set; }
}