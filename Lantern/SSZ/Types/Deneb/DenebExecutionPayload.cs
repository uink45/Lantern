...
public class DenebExecutionPayload
{
    ...
    [SszElement(12, "uint256")] public BigInteger ExcessDataGas { get; set; }

    [SszElement(13, "Vector[uint8, 32]")] public byte[] BlockHash { get; set; }

    [SszElement(14, "List[List[uint8, MAX_BYTES_PER_TRANSACTION], MAX_TRANSACTIONS_PER_PAYLOAD]")]
    public List<byte[]> Transactions { get; set; }
    
    [SszElement(15, "List[Container, MAX_WITHDRAWALS_PER_PAYLOAD]")]
