...
public class DenebBlockBody
{
    ...
    [SszElement(9, "Container")] public DenebExecutionPayload ExecutionPayload { get; set; }
    [SszElement(10, "List[Container, MAX_BLS_TO_EXECUTION_CHANGES]")] public List<SignedBLSToExecutionChange> BlsToExecutionChanges { get; set; }
    [SszElement(11, "List[Vector[uint8, 48], MAX_BLOBS_PER_BLOCK]")] public List<byte[]> BlobKzgCommitments { get; set; }
}